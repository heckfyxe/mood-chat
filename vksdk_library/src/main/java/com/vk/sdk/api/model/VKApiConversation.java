...
public class VKApiConversation extends VKApiModel implements Identifiable, Parcelable {
    ...
    public VKApiChatSettings chat_settings;
    ...
    public VKApiConversation(Parcel source) {
        ...
        chat_settings = source.readParcelable(VKApiChatSettings.class.getClassLoader());
    }
    ...
    public VKApiConversation parse(JSONObject in) {
        ...
        if (in.has("chat_settings")) {
            chat_settings = new VKApiChatSettings(in.optJSONObject("chat_settings"));
        }
